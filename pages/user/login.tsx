...
const Login: React.FC = () => {
  ...
  useEffect(() => {
    toast.warning(
      <div>
        <p>
          <b>Admin:</b>
          <br /> admin1@example.com <br /> admin123
        </p>
        <p>
          <b>Task:</b>
          <br /> bobbrown@example.com <br /> password123
        </p>
      </div>,
      {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Cookies.set("user", JSON.stringify(response.data.user.role), {
        expires: 1 / 24,
      });
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="bg-white shadow-lg rounded-lg w-100">
        <p className="text-center text-2xl font-bold font-sans mb-2 bg-blue-200 w-100">
          Login
        </p>
